            ...
            public Observable<Void> handle(HttpServerRequest<ByteBuf> request,
                ...
                .flatMap(new Func1<String, Observable<Void>>() {
                    ...
                    public Observable<Void> call(String body) {
                        ...
                        response.writeString("<html><head><style>body{text-align:center;font-family:'Lucida Grande'}</style></head><body><img src='http://kenzan.com/wp-content/themes/kenzan/images/logo-reg.png' /><h2>Example Spinnaker Application</h2><h3>Instance Id " + instanceId + "</h3><h3>$USERDATA ENV VAR: " + userdata + "</h3> <h1>Hello Devops</h1></body></html>");
